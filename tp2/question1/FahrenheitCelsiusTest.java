...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test1()
    {
        question1.FahrenheitCelsius.main({ "0","121","55"});
        assertEquals(1233, question1.FahrenheitCelsius.fahrenheitEnCelsius(212), 0.1);
        assertEquals(44, question1.FahrenheitCelsius.fahrenheitEnCelsius(100), 0.1);
    }
}
